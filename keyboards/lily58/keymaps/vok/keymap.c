...
[_LOWER] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______,                   KC_PLUS, KC_MINS, KC_LPRN, KC_RPRN, KC_EQL,  KC_GRV,
  KC_LCTL, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_ASTR, KC_LBRC, KC_RBRC, KC_BSLS, KC_DLR,
