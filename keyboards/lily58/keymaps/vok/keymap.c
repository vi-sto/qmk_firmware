 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI |LOWER |BackSP| /Space  /       \Space \  |Enter |RAISE | RAlt |
 *                   |      |      | LAlt |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                    //XXXXXXX, LGUI_??, LOW_BS,  KC_SPC,            KC_ENT, RSE_DEL, LALT_??, XXXXXXX  maybe change to this
                    //XXXXXXX, LGUI_??, LOW_BS,  LALT_?,            KC_SPC, RSE_ENT, ???????, XXXXXXX  maybe change to this
                      XXXXXXX, KC_LGUI, LOW_BS,  KC_SPC,            KC_SPC, RSE_ENT, LALT_BS, KC_RALT
),
/* COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |  `   |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  -   |
 ...
 */
 [_COLEMAK] = LAYOUT(
  ...
  _______,    KC_Z,    KC_X,    KC_C,    KC_D,    KC_V, KC_LBRC, KC_RBRC,    KC_K,    KC_H, _______, _______, _______, _______,
...
[_RAISE] = LAYOUT(
  ...
  KC_LCTL, KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                        KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_INS,  KC_DEL,
  KC_LSFT, KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   _______, QK_BOOT,   KC_PLUS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_PIPE,
                             _______, _______, _______,  _______, _______,   _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
  [_ADJUST] = LAYOUT(
  DF(_QWERTY), DF(_COLEMAK), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT,
